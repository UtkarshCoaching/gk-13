const questions = [
  ...
  {
    "question": "ভারতীয় সংবিধানের কোন অংশটি 'ম্যাগনা কার্টা' নামে পরিচিত?",
    "options": ["তৃতীয় অংশ (Part III)", "চতুর্থ অংশ (Part IV)", "পঞ্চম অংশ (Part V)", "প্রথম অংশ (Part I)"],
    "answer": "তৃতীয় অংশ (Part III)",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "কোন মুঘল সম্রাট তার নিজের আত্মজীবনী 'তুজুক-ই-বাবুরি' রচনা করেন?",
  ...
  {
    "question": "নিম্নলিখিত কোন গ্যাসটি বায়ুমণ্ডলে সবচেয়ে বেশি পরিমাণে থাকে?",
    "options": ["নাইট্রোজেন ($N_2$)", "অক্সিজেন ($O_2$)", "আর্গন ($Ar$)", "কার্বন ডাই অক্সাইড ($CO_2$)"],
    "answer": "নাইট্রোজেন ($N_2$)",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "আলাউদ্দিন খিলজি-এর সময়কালে বাজার নিয়ন্ত্রণ নীতি কে প্রয়োগ করেন?",
    "options": ["আলাউদ্দিন খিলজি", "জালালউদ্দিন খিলজি", "মুহাম্মদ বিন তুঘলক", "ফিরোজ শাহ তুঘলক"],
    "answer": "আলাউদ্দিন খিলজি",
    "userAnswer": null,
    "status": null
  },
  {
  ...
  {
    "question": "'স্বরাজ আমার জন্মগত অধিকার' – এই উক্তিটি কার?",
    "options": ["বাল গঙ্গাধর তিলক", "জওহরলাল নেহেরু", "মহাত্মা গান্ধী", "নেতাজি সুভাষ চন্দ্র বসু"],
    "answer": "বাল গঙ্গাধর তিলক",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "নিম্নলিখিত কোনটির জন্য 'ডান্ডি মার্চ' শুরু হয়েছিল?",
    "options": ["লবণ সত্যাগ্রহ", "অসহযোগ আন্দোলন", "ভারত ছাড়ো আন্দোলন", "স্বদেশী আন্দোলন"],
    "answer": "লবণ সত্যাগ্রহ",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতবর্ষে প্রথম জনগণনা (Census) কবে হয়েছিল?",
    "options": ["1872", "1881", "1901", "1947"],
    "answer": "1872",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ফ্লোরা' এবং 'ফনা' বলতে কী বোঝায়?",
    "options": ["উদ্ভিদ ও প্রাণীজগৎ", "ফুল ও ফল", "স্থল ও জল", "পর্বত ও নদী"],
    "answer": "উদ্ভিদ ও প্রাণীজগৎ",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "মানবদেহে কোন ভিটামিনের অভাবে রিকেটস রোগ হয়?",
  ...
  {
    "question": "প্রথম গোলটেবিল বৈঠক কোথায় অনুষ্ঠিত হয়েছিল?",
    "options": ["লন্ডন", "নয়াদিল্লি", "মুম্বাই", "কলকাতা"],
    "answer": "লন্ডন",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "কোন যন্ত্র দিয়ে বায়ুমণ্ডলীয় চাপ মাপা হয়?",
    "options": ["ব্যারোমিটার", "অ্যানিমোমিটার", "হাইগ্রোমিটার", "সিসমোগ্রাফ"],
    "answer": "ব্যারোমিটার",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "কোন গ্রহকে 'সন্ধ্যা তারা' (Evening Star) বলা হয়?",
  ...
  {
    "question": "কোনটির অভাবে মানবদেহে অ্যানিমিয়া রোগ হয়?",
    "options": ["লোহা", "ক্যালসিয়াম", "আয়োডিন", "ভিটামিন A"],
    "answer": "লোহা",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "পৃথিবীর সবচেয়ে লম্বা পর্বতমালা কোনটি?",
    "options": ["আন্দিজ পর্বতমালা", "হিমালয় পর্বতমালা", "রকি পর্বতমালা", "আলপস পর্বতমালা"],
    "answer": "আন্দিজ পর্বতমালা",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "কোন দেশের সংবিধান থেকে 'পঞ্চবার্ষিকী পরিকল্পনা' (Five-Year Plans) এর ধারণা নেওয়া হয়েছে?",
    "options": ["সোভিয়েত ইউনিয়ন", "মার্কিন যুক্তরাষ্ট্র", "ব্রিটেন", "ফ্রান্স"],
    "answer": "সোভিয়েত ইউনিয়ন",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "কে 'শেরশাহ সুরি'-এর আসল নাম?",
    "options": ["ফরিদ খান", "জালাল খান", "বাহাদুর খান", "নিজাম খান"],
    "answer": "ফরিদ খান",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "মৌলিক কর্তব্য (Fundamental Duties) ভারতের সংবিধানের কোন অংশে যুক্ত করা হয়েছে?",
    "options": ["চতুর্থ A অংশ (Part IV A)", "তৃতীয় অংশ (Part III)", "পঞ্চম অংশ (Part V)", "ষষ্ঠ অংশ (Part VI)"],
    "answer": "চতুর্থ A অংশ (Part IV A)",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতীয় অর্থনীতি কী ধরনের অর্থনীতি? / What type of economy is the Indian economy?",
    "options": ["মিশ্র অর্থনীতি", "পুঁজিবাদী অর্থনীতি", "সমাজতান্ত্রিক অর্থনীতি", "প্রাক-শিল্প অর্থনীতি"],
    "answer": "মিশ্র অর্থনীতি",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "লোহিত রক্তকণিকা (Red Blood Cells) কোথায় গঠিত হয়?",
    "options": ["অস্থিমজ্জা (Bone marrow)", "যকৃৎ (Liver)", "প্লীহা (Spleen)", "ফুসফুস (Lungs)"],
    "answer": "অস্থিমজ্জা (Bone marrow)",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "কয়লার কোন রূপটি সবচেয়ে বিশুদ্ধ? / Which form of coal is the purest?",
    "options": ["অ্যান্থ্রাসাইট", "বিটুমিনাস", "লিগনাইট", "পিট"],
    "answer": "অ্যান্থ্রাসাইট",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "আকাশ কেন নীল দেখায়?",
    "options": ["আলোর বিক্ষেপণ (Scattering)", "আলোর প্রতিফলন", "আলোর প্রতিসরণ", "আলোর বিচ্ছুরণ"],
    "answer": "আলোর বিক্ষেপণ (Scattering)",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "ভারতের কোন রাজ্যে 'কাজিরাঙ্গা জাতীয় উদ্যান' অবস্থিত?",
    "options": ["আসাম", "পশ্চিমবঙ্গ", "ওড়িশা", "কেরালা"],
    "answer": "আসাম",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "কোন যন্ত্র দিয়ে বায়ুর গতিবেগ মাপা হয়?",
    "options": ["অ্যানিমোমিটার", "ব্যারোমিটার", "হাইগ্রোমিটার", "সিসমোগ্রাফ"],
    "answer": "অ্যানিমোমিটার",
    "userAnswer": null,
    "status": null
  },
  {
    "question": "'সত্যমেব জয়তে' ভারতের কোন প্রতীক থেকে নেওয়া হয়েছে?",
    "options": ["মুন্ডক উপনিষদ", "বৃহদারণ্যক উপনিষদ", "ছান্দোগ্য উপনিষদ", "ঈশ উপনিষদ"],
    "answer": "মুন্ডক উপনিষদ",
    "userAnswer": null,
    "status": null
  }
